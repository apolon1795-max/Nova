...
2. в строке есть телефон родителя, результат, три сильные стороны и UTM-контекст;
3. Telegram получил тот же телефон и результат;
4. интерфейс показал успех только после сохранения;
5. работают «Скопировать результат» и «Скачать результат»;
